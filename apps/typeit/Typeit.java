 ...
 */
@Command(name = "typeit", mixinStandardHelpOptions = true, version = "typeit 1.0", description = "Simulates typing clipboard text (or specified string) into the active window after a"
		+ " countdown delay.")
