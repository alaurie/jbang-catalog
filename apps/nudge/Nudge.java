 ...
 */
@Command(name = "nudge", mixinStandardHelpOptions = true, version = "nudge 1.2", description = "Simulates user activity (mouse movement, key press, scrolling) when idle to keep your"
