...
class Killport implements Callable<Integer> {
	...
	@Option(names = { "-i", "--interactive" }, description = "Prompt confirmation [y/N] before killing each process.")
	private boolean interactive;

	@Option(names = { "-s",
			"--signal" }, description = "Termination signal: TERM (graceful) or KILL (forceful). Default: TERM.")
